function predictPrice() {
    ...
    if (Object.values(features).some(value => isNaN(value))) {
    ...
    .catch(error => {
        ...
        alert("Erreur lors de la prédiction. Vérifiez la connexion.");
    });
}